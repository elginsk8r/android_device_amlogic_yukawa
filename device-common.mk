...
ifeq ($(TARGET_ODROIDN2), true)
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/wifi/android.hardware.wifi@1.0-service-disable.rc:$(TARGET_COPY_OUT_VENDOR)/etc/init/hw/android.hardware.wifi@1.0-service-disable.rc
endif
